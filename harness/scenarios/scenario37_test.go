...
func TestScenario37_AnchorRetransmit(t *testing.T) {
	...
	gapsSuppressed := sumListenerDelta("s37", "bsl_gaps_suppressed_total", beforeL, afterL)
	gapsUnrecovered := sumListenerDelta("s37", "bsl_gaps_unrecovered_total", beforeL, afterL)
